    ...
    def creation_of_buttons(self):
        ...
        for y in range(self._y):
            for x in range(self._x):
                ...
                list_with_number.append(0) # Добавлення числа в список.
            ...
            a2.append(list_with_number)
            list_with_number = [] # Очищення списка.
            buttons = []
            kk_1 = []
        Button(window, text="start", width=3, height=1, bg="#00aa00", command=lambda :self.__pressing_on_green_button(s)).place(x=20, y=811) # Створення зеленої копки з парамитрами.
